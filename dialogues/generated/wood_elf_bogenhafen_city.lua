return function ()
	...
	define_rule({
		name = "pwe_level_bogenhafen_city_b\xC3\xB6genauer",
		response = "pwe_level_bogenhafen_city_b\xC3\xB6genauer",
		criterias = {
			{
				"query_context",
				"concept",
	...
	add_dialogues({
		...
		["pwe_level_bogenhafen_city_b\xC3\xB6genauer"] = {
			randomize_indexes_n = 0,
			face_animations_n = 4,
			database = "wood_elf_bogenhafen_city",
			sound_events_n = 4,
			...
			localization_strings = {
				"pwe_level_bogenhafen_city_b\xC3\xB6genauer_01",
				"pwe_level_bogenhafen_city_b\xC3\xB6genauer_02",
				"pwe_level_bogenhafen_city_b\xC3\xB6genauer_03",
				"pwe_level_bogenhafen_city_b\xC3\xB6genauer_04"
			},
			randomize_indexes = {},
			sound_events = {
				"pwe_level_bogenhafen_city_b\xC3\xB6genauer_01",
