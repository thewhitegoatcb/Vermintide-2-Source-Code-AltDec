return function ()
	...
	define_rule({
		name = "pdr_level_bogenhafen_city_b\xC3\xB6genauer",
		response = "pdr_level_bogenhafen_city_b\xC3\xB6genauer",
		criterias = {
			{
				"query_context",
				"concept",
			...
			},
			{
				...
				"item_tag",
				OP.EQ,
				"level_bogenhafen_city_b\xC3\xB6genauer"
			},
			{
				"query_context",
				"source_name",
	...
	add_dialogues({
		...
		["pdr_level_bogenhafen_city_b\xC3\xB6genauer"] = {
			randomize_indexes_n = 0,
			face_animations_n = 4,
			database = "dwarf_ranger_bogenhafen_city",
			sound_events_n = 4,
			...
			localization_strings = {
				"pdr_level_bogenhafen_city_b\xC3\xB6genauer_01",
				"pdr_level_bogenhafen_city_b\xC3\xB6genauer_02",
				"pdr_level_bogenhafen_city_b\xC3\xB6genauer_03",
				"pdr_level_bogenhafen_city_b\xC3\xB6genauer_04"
			},
			randomize_indexes = {},
			sound_events = {
				"pdr_level_bogenhafen_city_b\xC3\xB6genauer_01",
